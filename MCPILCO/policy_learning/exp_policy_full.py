...
# -*- coding: utf-8 -*-
"""
policy_learning/exp_policy_full.py
...
STRUCTURE (MC-PILCO, Amadio et al. 2022)
    ...
    python policy_learning/exp_policy_full.py \\
...
SAVE_DIR = os.path.join(_REPO, "results_expfull")
...
if _args.iters:
    N_ITERS = _args.iters
OUT = _args.out or os.path.join(SAVE_DIR, "exp_full_policy.pt")
