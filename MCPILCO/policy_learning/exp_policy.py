...
STRUCTURE (MC-PILCO, Amadio et al. 2022)
    ...
    python policy_learning/exp_policy.py \\
...
SAVE_DIR = os.path.join(_REPO, "results_exp")
...
if _args.iters:
    N_ITERS = _args.iters
OUT = _args.out or os.path.join(SAVE_DIR, "exp_policy.pt")
