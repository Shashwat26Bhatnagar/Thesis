...
if __name__ == '__main__': 
    ...
    filename = os.path.join(_parent_dir, 
                            'sindy_rl',
                            'config_templates', 
                            'dyna_pensim_latent.yml' # replace with appropriate config yaml
                            )
    ...
    ray.init(_temp_dir=os.environ.get('RAY_TMPDIR', '/tmp/ray_' + os.environ.get('USER','x')), address=ip_head, 
